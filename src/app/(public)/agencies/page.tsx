  ...
  return (
    <main className="mx-auto max-w-[var(--max-width)] px-6 pb-20 pt-12">
      ...
      <div className="mt-12 rounded-[var(--radius)] border border-border bg-surface p-8 text-center">
        ...
        <Link
          href="/for-agencies"
          className="inline-flex rounded-[var(--radius-sm)] bg-text-primary px-6 py-3 text-sm font-semibold text-white no-underline transition-colors hover:bg-text-primary-hover"
        >
          Learn More →
        </Link>
      </div>
